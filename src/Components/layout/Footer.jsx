...
export const Footer = () => {
    const data = [
        { id: 1, text: 'About Blacklane', link: '/en/about/' },
        { id: 2, text: 'Career', link: '/en/career/' },
        { id: 3, text: 'Press', link: '/en/press/releases/' },
        { id: 4, text: 'Blog', link: 'https://blog.blacklane.com/' },
        { id: 5, text: 'Green initiatives', link: '/en/sustainability/' },
        { id: 6, text: 'Become a chauffeur partner', link: '/en/partners/' },
        { id: 7, text: 'Influencers', link: '/en/influencers/' },
    ];
    const links = [
        { text: 'Overview', href: '/en/business/' },
        { text: 'Corporations', href: '/en/corporations/' },
        { text: 'Travel agencies', href: '/en/travel-agencies/' },
        { text: 'Strategic partnerships', href: '/en/strategic-partnerships/' },
    ];
    const linkData = [
        { id: 1, city: 'New York', href: '/en/airport-transfer-new-york/' },
        { id: 2, city: 'London', href: '/en/airport-transfer-london/' },
        { id: 3, city: 'Berlin', href: '/en/airport-transfer-berlin/' },
        { id: 4, city: 'Los Angeles', href: '/en/airport-transfer-los-angeles/' },
        { id: 5, city: 'Paris', href: '/en/airport-transfer-paris/' },
        { id: 6, city: 'All cities', href: '/en/cities/' },
    ];
    const footerLinks = [
        { text: 'City-to-city rides', href: '/en/city-to-city/' },
        { text: 'Limousine service', href: '/en/limousine-service/' },
        { text: 'Chauffeur service', href: '/en/chauffeur-service/' },
        { text: 'Private car service', href: '/en/car-service/' },
        { text: 'Ground transportation', href: '/en/ground-transportation/' },
        { text: 'Airport transfer', href: '/en/airport-transfer/' },
        { text: 'All countries', href: '/en/countries/' },
    ];
    const dataCity = [
        { text: 'New York - East Hampton', href: '/en/long-distance-new-york-east-hampton/' },
        { text: 'Los Angeles - San Diego', href: '/en/long-distance-los-angeles-san-diego/' },
        { text: 'Miami - Palm Beach', href: '/en/long-distance-miami-palm-beach/' },
        { text: 'London - Bristol', href: '/en/long-distance-london-bristol/' },
        { text: 'Dubai - Abu Dhabi', href: '/en/long-distance-abu-dhabi-dubai/' },
        { text: 'Paris - Reims', href: '/en/long-distance-paris-reims/' },
    ];
    const legalLinks = [
        { id: 1, text: 'Terms', href: '/en/terms/' },
        { id: 2, text: 'Privacy policy', href: '/en/privacy-policy/' },
        { id: 3, text: 'Legal notice', href: '/en/imprint/' },
        { id: 4, text: 'Accessibility', href: '/en/accessibility/' },
    ];

    return (
        <div className='text-white bg-black py-[40px]'>
            <div className="container mx-auto px-[16px]">
                <div className="flex justify-between border-b border-[#313338] pb-[32px]">
                    <img src="/assets/images/logo.svg" className='w-[170px]' alt="" />
                    <div className="flex items-center gap-1">
                        <svg role="img" aria-label="Icon/theater" class="remixicon-icon footer_helpLinkIcon__N2zkN icon_linkInverse__1rSPZ" width="20px" height="20px" fill="currentColor" viewBox="0 0 24 24"><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm-1-7v2h2v-2h-2zm2-1.645A3.502 3.502 0 0 0 12 6.5a3.501 3.501 0 0 0-3.433 2.813l1.962.393A1.5 1.5 0 1 1 12 11.5a1 1 0 0 0-1 1V14h2v-.645z"></path></svg>
                        <p className='underline'>Help</p>
                    </div>
                </div>
                <div className="flex gap-2 py-4 border-b border-[#313338]">
                ...
                <div className="py-[30px] border-b border-[#313338]">
                    <div className="flex justify-between flex-wrap">
                        <div className="">
                            <h1 className='leading-[22px] text-[16px] font-bold mb-[20px]'>Company</h1>
                            <ul className='list-none '>
                                {data.map((item) =>
                                    <li className='mb-[12px] mr-[16px] text-[#b0b2b7] text-[16px] hover:underline hover:text-white'>
                                        {item.text}
                                    </li>
                                )}
                        ...
                        <div className="">
                            <h1 className='leading-[22px] text-[16px] font-bold mb-[20px]'>Blacklane for Business</h1>
                            <ul className='list-none '>
                                {links.map((item) =>
                                    <li className='mb-[12px] mr-[16px] text-[#b0b2b7] text-[16px] hover:underline hover:text-white'>
                                        {item.text}
                        ...
                        <div className="">
                            <h1 className='leading-[22px] text-[16px] font-bold mb-[20px]'>Top cities</h1>
                            <ul className='list-none '>
                                {linkData.map((item) =>
                                    <li className='mb-[12px] mr-[16px] text-[#b0b2b7] text-[16px] hover:underline hover:text-white'>
                                        {item.city}
                        ...
                        <div className="">
                            <h1 className='leading-[22px] text-[16px] font-bold mb-[20px]'>Explore</h1>
                            <ul className='list-none '>
                        ...
                        <div className="">
                            <h1 className='leading-[22px] text-[16px] font-bold mb-[20px]'>City to City rides</h1>
                            <ul className='list-none '>
                                {dataCity.map((item) =>
                                    <li className='mb-[12px] mr-[16px] text-[#b0b2b7] text-[16px] hover:underline hover:text-white'>
                                        {item.text}
